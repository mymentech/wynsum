    ...
    <div class="p-head-cont">
        <div class="p-head">
            ...
            <div class="p-action">
                ...
                <a href="<?php echo get_permalink($pid)."?mt-image-id={$_gid}"; ?>" data-id="<?php echo esc_attr($pid); ?>" class="quick-view-btn" aria-label="<?php esc_attr_e('Show in Quickview', 'minera'); ?>">
                ...
                <span class="p-box-atc">
                    <?php if($variation): ?>
                        <a href="<?php echo get_permalink($pid)."?mt-image-id={$_gid}"; ?>" class="select-option-btn ht-ico-cart" aria-label="<?php esc_attr_e('Select Options', 'minera'); ?>">
            ...
            <?php /*product image*/ ?>
            <a href="<?php echo get_permalink($pid)."?mt-image-id={$_gid}"; ?>" class="p-image" aria-label="<?php esc_attr_e('Product image', 'minera'); ?>" data-ori_src="<?php echo esc_attr($origin_src[0]); ?>">
        ...
        <div class="p-content">
            <a class="p-title" href="<?php echo get_permalink($pid)."?mt-image-id={$_gid}"; ?>" aria-label="<?php esc_attr_e('Product title', 'minera'); ?>"><?php echo get_the_title($pid); ?></a>
            ...
            <div class="atc-shop-list">
                <?php if($variation): ?>
                    <a href="<?php echo get_permalink($pid)."?mt-image-id={$_gid}"; ?>" class="atc-select-option-btn" aria-label="<?php esc_attr_e('Select Options', 'minera'); ?>"><?php esc_html_e('Select Options', 'minera'); ?></a>
                <?php else: ?>
                    <a href="<?php echo esc_url($atc_url)."?mt-image-id={$_gid}"; ?>" data-quantity="1" data-product_id="<?php echo esc_attr($pid); ?>" class="add_to_cart_button ajax_add_to_cart" aria-label="<?php esc_attr_e('Add to Cart', 'minera'); ?>"><?php esc_html_e('Add to Cart', 'minera'); ?></a>
                <?php endif; ?>
            </div>
        </div>
        <?php minera_swatches_list();/*swatches color*/ ?>
