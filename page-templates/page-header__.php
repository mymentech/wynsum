...
if(!is_404() && $final_bread_display == '1'): ?>
    <nav class="theme-breadcrumb flw" <?php echo wp_kses_post($final_bread_style); ?>>
        <div class="bread-spacing-top flw" <?php echo wp_kses_post($spacing_top); ?>></div>
        <div class="container">
